...
export default function Login(props) {
    ...
    const url_login =  Config.api_domain + "/auth/loginAdmin";
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    if (json.Authorization) {
                        ...
                        setCookie('ADMIN_TOKEN', json.Authorization)
        ...
        <Row className="main font-11 pb-5">
                ...
                <Col lg={4} className="mt-5 px-0 mb-5 bg-white font-11 border">
                    ...
                    <div className="text-center bg-key p-3 m-0">
                        <h6 className="text-dark font-weight-bold">LOGIN TO FTA GEOPORTAL</h6>
                    </div>
