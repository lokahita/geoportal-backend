...
function App() {
  ...
  const url_valid = Config.api_domain + "/auth/validAdmin";
  /*
  useEffect(() => {
  ...
  */
  ...
  var login_check = token? tokenValid? <Backend /> : <Login tokenValid={tokenValid} /> : <Login tokenValid={tokenValid} />
            ...
            <Fade top delay={1500} duration={1500}>
              ...
              <Row className={tokenValid?"main-admin border-bottom" : "main border-bottom"} >
                ...
                <Zoom delay={1500} duration={1500}>
                  {
                    tokenValid? <Backend />: login_check
                  }
