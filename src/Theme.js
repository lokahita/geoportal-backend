...
export default function Theme(props) {
    ...
    const url_list = Config.api_domain + "/themes/";
    const url_insert = Config.api_domain + "/themes/";
    const url_update = Config.api_domain + "/themes/update/";
    const url_delete = Config.api_domain + "/themes/delete/";
    ...
    const card = (
        <>
            <Card className={tabel}>
                <Card.Body>
                    <Alert variant="warning">
                        <span className="text-uppercase"><b>List of theme</b></span>
                    </Alert>
                    ...
                    <Form.Group>
                        <Button variant="success" type="button" block onClick={() => setModeInsert()} className="font-11 py-0" size="sm">Add a new theme</Button>
                    </Form.Group>
            ...
            <Card className={status} id="#form_isian">
                <Card.Body>
                    <Alert variant="warning">
                        <span className="text-uppercase"><b>Theme form</b></span>
                    </Alert>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Row>
                            ...
                            <Col>
                                <Form.Group>
                                    <Button variant="success" type="submit" block disabled={!validateForm()} className="font-11 py-0" size="sm" title="Theme name field must be inserted">{tombolUsulan} Theme</Button>
                                </Form.Group>
                            </Col>
                        </Form.Row>
                    </Form>
